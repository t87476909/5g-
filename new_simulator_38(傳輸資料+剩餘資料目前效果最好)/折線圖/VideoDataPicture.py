...
plt.figure()
plt.plot(Video_data,unit_throughput_awake_time_list[0],'s-',color = 'r', label="Our_1RX")
plt.plot(Video_data,unit_throughput_awake_time_list[1],'o-',color = 'g', label="Our_2RX")
...
plt.xlabel("Video_data")
plt.ylabel("unit awake time of System throughput")
plt.legend(loc = "best")
plt.savefig('Video_unit_time_System_throughput.pdf')

plt.figure()
plt.plot(Video_data,system_throughput_list[0],'s-',color = 'r', label="Our_1RX")
plt.plot(Video_data,system_throughput_list[1],'o-',color = 'g', label="Our_2RX")
...
plt.figure()
plt.plot(Video_data,power_saving_list[0],'s-',color = 'r', label="Our_1RX")
plt.plot(Video_data,power_saving_list[1],'o-',color = 'g', label="Our_2RX")
...
plt.figure()
plt.plot(Video_data,avg_delay_list[0],'s-',color = 'r', label="Our_1RX")
plt.plot(Video_data,avg_delay_list[1],'o-',color = 'g', label="Our_2RX")
...
plt.figure()
plt.plot(Video_data,avg_loss_list[0],'s-',color = 'r', label="Our_1RX")
plt.plot(Video_data,avg_loss_list[1],'o-',color = 'g', label="Our_2RX")
