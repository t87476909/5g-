...
class SystemInfo:
    ...
    system_round = 10 #系統執行輪數(老師規定要9次)
    ntu_T_time = 2 #台大系統執行T時間
    ue_move_cycle = 1 # ms 1ms移動一次ue座標

class Simulation:
    mode = 0 #系統執行模式 0為我的方法(one) 1為我的方法(two) 2為全部靜態 3為台大參考論文方法 4為新論文 5為僅有softmax
    all_mode_test = True #為全部方法模擬
    beam_clear = True #是否讓某些波束消失
    ue_move_control = False
    picture = 0 # 0為ue數量為x軸、1為ue_speed為x軸、2為
