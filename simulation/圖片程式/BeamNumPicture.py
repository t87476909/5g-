...
with open(path, newline='') as csvfile:
  ...
  for row in rows:
    ...
    if float_row[13] == 0:
      ...
      if float_row[20] not in system_throughput[5]:
        system_throughput[5][float_row[20]] = float_row[0]
        avg_delay[5][float_row[20]] = float_row[8]
        avg_loss[5][float_row[20]] = float_row[12]
        average_UE_awake[5][float_row[20]] = float_row[14]
        unit_throughput_awake_time[5][float_row[20]] = float_row[16]
        power_saving[5][float_row[20]] = float_row[17]
      else:
        system_throughput[5][float_row[20]] += float_row[0]
        avg_delay[5][float_row[20]] += float_row[8]
        avg_loss[5][float_row[20]] += float_row[12]
...
plt.figure()
plt.plot(beam_number,unit_throughput_awake_time_list[5],'*-',color = 'm', label="OUR")
plt.plot(beam_number,unit_throughput_awake_time_list[0],'s-',color = 'r', label="OUR+${DC_{1rx}}$")
plt.plot(beam_number,unit_throughput_awake_time_list[1],'o-',color = 'g', label="OUR+${DC_{2rx}}$")
...
plt.figure()
plt.plot(beam_number,system_throughput_list[5],'*-',color = 'm', label="OUR")
plt.plot(beam_number,system_throughput_list[0],'s-',color = 'r', label="OUR+${DC_{1rx}}$")
plt.plot(beam_number,system_throughput_list[1],'o-',color = 'g', label="OUR+${DC_{2rx}}$")
...
plt.figure()
plt.plot(beam_number,power_saving_list[5],'*-',color = 'm', label="OUR")
plt.plot(beam_number,power_saving_list[0],'s-',color = 'r', label="OUR+${DC_{1rx}}$")
plt.plot(beam_number,power_saving_list[1],'o-',color = 'g', label="OUR+${DC_{2rx}}$")
...
plt.figure()
plt.plot(beam_number,avg_delay_list[5],'*-',color = 'm', label="OUR")
plt.plot(beam_number,avg_delay_list[0],'s-',color = 'r', label="OUR+${DC_{1rx}}$")
plt.plot(beam_number,avg_delay_list[1],'o-',color = 'g', label="OUR+${DC_{2rx}}$")
...
plt.figure()
plt.plot(beam_number,avg_loss_list[5],'*-',color = 'm', label="OUR")
plt.plot(beam_number,avg_loss_list[0],'s-',color = 'r', label="OUR+${DC_{1rx}}$")
plt.plot(beam_number,avg_loss_list[1],'o-',color = 'g', label="OUR+${DC_{2rx}}$")
